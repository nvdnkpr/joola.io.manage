function charts() {
  ...
  if ($("#stats-chart2").length) {
    ...
    var dateArray = [[1, '01/01/01'],[2, '01/01/01'],[3, '01/01/01'],[4, '01/01/01'],[5, '01/01/01']];
    var plot = $.plot($("#stats-chart2"),
      [
        { data: avgSourceQueryTime, label: "Avg Source Query Time"},
        { data: avgCacheQueryTime, label: "Avg Cache Query Time"}
      ], {
        series: {
          lines: { show: true,
            lineWidth: 2
        ...
        xaxis: {mode: "time", timeformat: "%Y/%m/%d", ticks: dateArray},
