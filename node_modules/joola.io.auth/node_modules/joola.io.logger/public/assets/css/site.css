...
.left-nav .options-env,
.left-nav .options-component,
.left-nav .options-level {
    margin-top: 10px;
...
.console .line .showmore {
    cursor: pointer;
}

.console .line .showmore:hover {
    text-decoration: underline;
}
...
body.status div.logo .logo-image {
    background-image: url('/assets/img/logo.logger.dark.png');
    width: 301px;
    height: 50px;
}
body.login div.logo .logo-image{
    background-image: url('/assets/img/logo.logger.png');
    width: 301px;
    height: 50px;
}
